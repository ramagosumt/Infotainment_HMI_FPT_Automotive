...
class MediaViewModel : public QObject
{
    ...
    Q_PROPERTY(qint8   currentSourceRaw             READ getCurrentSourceRaw            NOTIFY onCurrentMediaChanged)
    Q_PROPERTY(qint32  currentDurationRaw           READ getCurrentDurationRaw          NOTIFY onCurrentMediaChanged)
    Q_PROPERTY(qint32  currentTimeRaw               READ getCurrentTimeRaw              NOTIFY onCurrentMediaChanged)

    Q_PROPERTY(QString nextSource                   READ getNextSource                  NOTIFY onNextMediaChanged)
    Q_PROPERTY(QString nextAlbum                    READ getNextAlbum                   NOTIFY onNextMediaChanged)
    Q_PROPERTY(QString nextArtist                   READ getNextArtist                  NOTIFY onNextMediaChanged)
    Q_PROPERTY(QString nextSong                     READ getNextSong                    NOTIFY onNextMediaChanged)
    Q_PROPERTY(QString nextDuration                 READ getNextDuration                NOTIFY onNextMediaChanged)
    Q_PROPERTY(QString nextTime                     READ getNextTime                    NOTIFY onNextMediaChanged)
    Q_PROPERTY(QString nextSourceIcon               READ getNextSourceIcon              NOTIFY onNextMediaChanged)
    Q_PROPERTY(qint8   nextSourceRaw                READ getNextSourceRaw               NOTIFY onNextMediaChanged)
    Q_PROPERTY(qint32  nextDurationRaw              READ getNextDurationRaw             NOTIFY onNextMediaChanged)
    Q_PROPERTY(qint32  nextTimeRaw                  READ getNextTimeRaw                 NOTIFY onNextMediaChanged)

public:
    explicit MediaViewModel(QObject *parent = nullptr);
    explicit MediaViewModel(MediaModel* model, QObject *parent = nullptr);
    ...
    Q_INVOKABLE void setCurrentMedia(const qint8 source, const QString &album, const QString &artist, const QString &song, const qint32 duration, const qint32 time);
    Q_INVOKABLE void setNextMedia(const qint8 source, const QString &album, const QString &artist, const QString &song, const qint32 duration, const qint32 time);
