...
qint8 WeatherModel::getCurrentTemperature() const {
...
qint8 WeatherModel::getCurrentWindSpeed() const {
...
qint8 WeatherModel::getDestinationTemperature() const {
...
qint8 WeatherModel::getDestinationWindSpeed() const {
